    ...
    return (
        <Box role='button' onClick={() => {
            ...
            <Box padding={"24px"} rounded={"10px"} background={"white"} >
                <Flex pb={"24px"} borderBottom={"1px solid rgba(3, 15, 34, 0.3)"} justifyContent={"space-between"} alignItems={"center"} >
                    <Text fontFamily={"Satoshi"} fontWeight={"black"} fontSize={"28px"} color={"#030F22"} letterSpacing={"-5%"}>
                        {title}
                    </Text>
                    <Flex ref={iconRef} alignItems={"center"} justifyContent={"center"} bg={"#030F22"} height={"36px"} width={"36px"} rounded={"full"}>
                        <FaChevronDown color={"#C1C7F9"} />
                    </Flex>
                </Flex>
                <Box ref={childRef} height={"0px"} overflow={"hidden"}>
                    <Text pt={"24px"} fontFamily={"Satoshi"} fontWeight={"medium"} fontSize={"20px"} color={"#030F22"} letterSpacing={"-5%"}>
                        {text}
                    </Text>
                </Box>
